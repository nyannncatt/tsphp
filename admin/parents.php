...
// Get all parents with their associated users
$query = "SELECT p.*, u.email, u.username FROM parents p 
          JOIN users u ON p.user_id = u.id 
          ORDER BY p.last_name, p.first_name";
$parents = $conn->query($query);
?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view_parent.php?id=<?php echo $parent['id']; ?>" class="btn btn-sm btn-info">View</a>
                                    <a href="edit_parent.php?id=<?php echo $parent['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                    <button class="btn btn-sm btn-danger" onclick="deleteParent(<?php echo $parent['id']; ?>)">Delete</button>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" method="POST" action="delete_parent.php" style="display: inline;">
