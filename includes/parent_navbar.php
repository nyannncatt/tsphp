...
<nav class="top-navbar">
    <div class="nav-container d-flex justify-content-between align-items-center">
        ...
        <ul class="nav-menu">
            ...
            <li>
                <a href="children.php" class="nav-link <?php echo $current_page == 'children.php' ? 'active' : ''; ?>">
...
<div class="side-navbar">
    ...
    <ul class="side-menu">
        ...
        <li>
            <a href="children.php" class="side-link <?php echo $current_page == 'children.php' ? 'active' : ''; ?>">
                <i class="bi bi-mortarboard-fill"></i>
                My Student
            </a>
        </li>
