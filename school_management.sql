...
(1, 'acee', 'acee', 2, '2025-05-15 16:22:53');
...
INSERT INTO `grades` (`id`, `student_id`, `course_id`, `grade`, `grading_period`, `created_at`) VALUES
(1, 1, 1, 11.00, NULL, '2025-05-15 16:53:03'),
(2, 1, 1, 0.00, NULL, '2025-05-15 16:53:26'),
(3, 1, 1, 2.00, NULL, '2025-05-15 16:53:47');
...
(1, 2, 1, 'a', 'a', 0, '2025-05-15 17:18:36'),
(2, 1, 2, 'aaa', 'aaaaa', 1, '2025-05-15 17:36:09'),
(3, 5, 1, 's', 's', 0, '2025-05-15 18:10:42');
...
INSERT INTO `parents` (`id`, `user_id`, `first_name`, `last_name`, `phone`, `address`) VALUES
(3, 5, 'parent', 'yes', '222', 'here');
...
INSERT INTO `students` (`id`, `user_id`, `first_name`, `last_name`, `date_of_birth`, `grade_level`) VALUES
(1, 1, 'student', 'yes', NULL, 2);
...
(1, 'kamirelax187@gmail.com', '$2y$10$OTPPocDbenZpcAInprLS8OcsA42gFL9sYhMJhw28l6ed4iW.eJifi', 'kamirelax187@gmail.com', 'student', '2025-05-15 16:05:25'),
(2, 'admin', '$2y$10$rItuYFaYuIEiH2VNDnfqw.FTmIzskOEZjk0qoYDN.Txa4wpI0D036', 'admin@school.com', 'admin', '2025-05-15 16:08:02'),
(5, 'parent', '$2y$10$N4QoC/20rU9MYnUUX/Rgf.HJxBaNn/MhSHbipXcPKxUK7ayWvWMx2', 'parent@gmail.com', 'parent', '2025-05-15 18:02:39');
